...
import gearPick from '../assets/images/20220602_143241.jpg';
import synth from '../assets/images/20220602_143253.jpg';
import composingSetup from '../assets/images/20221220_094620.jpg';
      ...
      <section id='servicesPage'>
        <h3 id='servicesHeader'>Services</h3>
          <section className='serviceCard' id='soundDesign'>
            ...
            <section className='servicesSideBySide'>
              <img id='gearPick' src={gearPick} alt='Gear Pick equipment'></img>
              <ul>
          ...
          <section className='serviceCard' id='mixingAndMastering'>
            ...
            <section className='servicesSideBySide'>
              ...
              <img id='synth' src={synth} alt='analogSynthesizer'></img>
            </section>
          </section>
          <section className='serviceCard' id='producing'>
            <h4>Producing & Composing</h4>
            ...
            <img id='composingSetup' src={composingSetup} alt='Composing setup'></img>
